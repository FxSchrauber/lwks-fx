...
// @Author schrauber
// @Created 2017-02-01
// @see https://www.lwks.com/media/kunena/attachments/348533/RC_RGB-Gain.png
...
//    File renamed from "RC_Gain_RGB.fx"  to "rc_Gain_RGB.fx"
//    Renamed effect from "RC RGB-Gain" to "rc Gain (RGB)"
...
<
   ...
   string Description = "rc Gain (RGB)";
...
float4 main( float2 xy : TEXCOORD1 ) : COLOR
{
   ...
   return  min (float4 (retval.r * (1.0 + fn_receiving05(ChRed)),
                        retval.g * (1.0 + fn_receiving05(ChGreen)),
                        retval.b * (1.0 + fn_receiving05(ChBlue)),
                        retval.a), 1.0);
}
