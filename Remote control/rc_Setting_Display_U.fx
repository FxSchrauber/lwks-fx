...
It's a very handy diagnostic tool for this class of effect. <br>
 <br>
Version note: This Revised version is now compatible with all GPU precision settings added with Lightworks 14.5. 
(unlike older versions before July 2018)
*/


//--------------------------------------------------------------//
// Lightworks user effect rc_Setting_Display_U.fx
//
// Update 06 January 2018 by LW user schrauber:
// File renamed from "Setting_Display_Unit.fx"  to "rc_Setting_Display_U.fx"
// Renamed effect from "Settings Display Unit20180725" to "rc Settings display unit"
...
<
   ...
   string Description = "rc Settings display unit";
